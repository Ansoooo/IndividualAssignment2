...
public class BulletController : MonoBehaviour
{
    ...
    BulletPoolManager accessBulletPoolManager;

    void Start()
    {
        accessBulletPoolManager = GameObject.Find("BulletPoolManager").GetComponent<BulletPoolManager>();
    ...
    private void CheckBounds()
    {
        if (transform.position.y >= boundary.Top)
        {
            ...
            accessBulletPoolManager.ResetBullet(gameObject);
        }
    }
}
